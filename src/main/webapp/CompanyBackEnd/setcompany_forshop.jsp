...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					<!-- form start -->
					<form method="post" action="company_memberdo" name="form1" enctype="multipart/form-data">
						...
						<div class="col-md-6">
							...
							<div class="box box-primary">
								...
								<div class="box-body">
									...
									<div class="form-group">
										<label for="store_logo">賣場Logo</label> <input type="file" id="store_logo" name="store_logo" class="upl1"> <br />
										<div>
											<img id="store_logo_show" style="max-width: 150px; max-height: 150px;">
											<div class="size"></div>
										</div>
									...
									<div class="form-group">
										<label for="store_banner">賣場Banner</label> <input type="file" id="store_banner" name="store_banner" class="upl2">
										<div>
											<img id="store_banner_show" style="max-width: 150px; max-height: 150px;">
											<div class="size"></div>
										</div>
										<p class="help-block"></p>
									</div>
	...
	<script>
        ...
        $(function () {
            ...
            function store_logo(input) {

                if (input.files && input.files[0]) {
                    var reader = new FileReader();

                    reader.onload = function (e) {
                        $('#store_logo_show').attr('src', e.target.result);
        ...
        $(function () {
            ...
            function store_banner(input) {
                ...
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function (e) {
                        $('#store_banner_show').attr('src', e.target.result);
