...
<title>商品類別資料新增 - addProduct_type.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>商品類別資料新增 - addProduct_type.jsp</h3></td><td>
...
<FORM METHOD="post" ACTION="product_type.do" name="form1" > 
<table>
	<tr>
		<td>類型編號:</td>
		<td><input type="TEXT" name="typeCode" size="12" 
			 value="<%= (product_typeVO==null)? "" : product_typeVO.getTypeCode()%>" /></td>
	</tr>
	<tr>
		<td>類型名稱:</td>
		<td><input type="TEXT" name=typeName size="15"
