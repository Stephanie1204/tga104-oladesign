        ...
        <section class="content">
          ...
          <div class="panel panel-default">
            ...
            <div class="row data-type">
              ...
              <div class="col-md-2 title">訂購人</div>
              <div class="col-md-4 data">
                <input type="text" class="form-control" value="" readonly />
              </div>
          ...
          <div class="panel panel-default">
            ...
            >
              ...
              <tbody>
                <tr>
                  <td>19</td>
                  <td>MINERVA 和風木質吊燈 (附小夜燈)~深棕色</td>
                  <td>2</td>
                  <td>商品單價</td>
                  <td>商品單價*商品數量=商品總計</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="panel panel-default checkout">
            ...
            <div class="row data-type">
              ...
              <div class="col-md-4 data text">5689aryj</div>

              <div class="col-md-2 title">紅利折抵</div>
              <div class="col-md-4 data text">-扣紅利</div>

              <div class="col-md-2 title">結帳金額</div>
              <div class="col-md-4 data text">折完紅利&折扣碼後的最後金額</div>
            </div>
          </div>
          <!--結帳資訊/-->
          <!--工具栏-->
