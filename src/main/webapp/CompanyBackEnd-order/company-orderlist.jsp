                      ...
                      <li>
                        <a href="#">
                          ...
                          <h4>
                            团队消息
                            <small
                              ><i class="fa fa-clock-o"></i> 2 小时前</small
                            >
                          </h4>
                          <p>你有新的任务了</p>
                        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li id="admin-documentation">
              <a href="documentation.html" target="_blank"
                ><i class="fa fa-book"></i> <span>AdminLTE汉化文档</span></a
              >
            </li>
          </ul>
        </section>
          ...
          <div class="box-body">
            ...
            <div class="nav-tabs-custom">
              ...
              <ul class="nav nav-tabs">
                <li class="active">
                  <a href="#all-orderlist" data-toggle="tab">全部訂單</a>
                </li>
                <li>
                  <a href="#tobeconfirmed-orderlist" data-toggle="tab"
                    >待確認</a
                  >
                </li>
                <li>
                  <a href="#complete-orderlist" data-toggle="tab">已成立</a>
                </li>
                <li>
                  <a href="#cancel-orderlist" data-toggle="tab">已取消</a>
                </li>
              </ul>
              <!--tab头/-->
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="all-orderlist">
                  ...
                  >
                    <thead>
                      <tr>
                        <th class="sorting">訂單時間</th>
                        <th class="sorting">訂單狀態</th>
                        <th class="sorting">物流狀態</th>
                        <th class="sorting">折扣碼</th>
                        <th class="sorting">結帳金額</th>
                        <th class="sorting">紅利折抵</th>
                        <th class="sorting">收件人名稱</th>
                        <th class="sorting">收件地址</th>
                        <th class="sorting">紅利新增</th>
