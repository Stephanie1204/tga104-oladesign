...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/back-end/assets/css/fontawesome-all.min.css">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="card text-white bg-info shadow">
                                	<a href="<%=request.getContextPath()%>/back-end/report/memReport.jsp" onclick="window.assign(this.href, '', 'width=800,height=800'); return false;">
	                                    <div class="card-body">
