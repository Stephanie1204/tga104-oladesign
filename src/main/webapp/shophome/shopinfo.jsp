...
<body>
	...
	<section class="blog-details-hero set-bg"
		data-setbg="../shophome-img/blog/details/details-hero.jpg">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="blog__sidebar">
						<div class="blog__sidebar__item">
							<div class="blog__details__author__pic">
								<img src="../shophome-img/blog/details/details-author.jpg"
									alt="">
							</div>
						</div>
						<div class="blog__sidebar__item">
						...
						<div class="blog__sidebar__item">
							<h4></h4>
							<div class="blog__sidebar__item__tags"></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="footer__about">
						<div class="footer__about__logo">
							<a href="./index.html"><img src="../shophome-img/logo.png"
								alt=""></a>
						</div>
						<ul>
