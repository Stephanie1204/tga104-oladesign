...
<%@ include file="../chatroom/chat02.jsp"%>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="../shophome-img/logo.png" alt=""></a>
        </div>
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__language">
                <img src="../shophome-img/language.png" alt="">
                <div>English</div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="../shophome-img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="blog-details-hero set-bg" data-setbg="../shophome-img/blog/details/details-hero.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                    ...
                    <div class="blog__sidebar">
                        <div class="blog__sidebar__item">
                            <div class="blog__details__author__pic">
                                <img src="../shophome-img/blog/details/details-author.jpg" alt="">
                            </div>
                        </div>
                        <div class="blog__sidebar__item">
                            <h4>Recent News</h4>
                            <div class="blog__sidebar__recent">
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="../shophome-img/blog/sidebar/sr-1.jpg" alt="">
                                    </div>
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="../shophome-img/blog/sidebar/sr-2.jpg" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="../shophome-img/blog/sidebar/sr-3.jpg" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                ...
                <div class="col-lg-8 col-md-7 order-md-1 order-1">
                    <div class="blog__details__text">
                    	<form id="myForm" method="post" action="<%=request.getContextPath() %>/chatroom/chat.do">
                    		<div style = text-align:right>
                    			<input type="submit" name="action" id="send" value="點我聊聊" >
                    			<input type="hidden" name="mem_0" value="220001">
                    			<input type="hidden" name="mem_1" value="220002">
                    		</div>
                    	</form>
                        <h3>賣家介紹</h3>
                        <p>賣家介紹賣家介紹賣家介紹賣家介紹賣家介紹賣家介紹賣家介紹賣家介紹賣家介紹</p>
                    </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="../shophome-img/payment-item.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
