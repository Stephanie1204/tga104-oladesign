		...
		<div id="addAdmin">
			...
			<form METHOD="post" ACTION="intermail.do" class="addAdmin"
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<td><input type="text" class="form-control" name="adminId" readonly="readonly"
							id="adminId" maxlength="4" size="4"
							value="<%=(intermailVO == null) ? adminVO.getAdminId() : intermailVO.getAdminId()%>" /></td>
					</div>
				</div>
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						...
						<td><textarea style="width: 420px; height: 300px"
								name="conTent" id="conTent" maxlength="1000"
								placeholder="請輸入內容 (1-1000個字) "
