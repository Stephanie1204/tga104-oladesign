			...
			<div class="box-tools pull-right">
				<div class="has-feedback">
					<form method="post"
						...
						<input type="text" name="memId" placeholder="請輸入會員編號"> <input
				...
				<table class="table table-striped table-sm table-hover">
					...
					<c:forEach var="memberVO" items="${list}" begin="<%=pageIndex%>"
						...
						<tr>
							...
							<td><c:if test="${memberVO.isBan==true}">停用</c:if> <c:if
									test="${memberVO.isBan==false}">正常</c:if></td>
							...
							<td>
								<FORM METHOD="post"
									ACTION="<%=request.getContextPath()%>/MemberForAdmin"
									style="margin-bottom: 0px;">
									<input type="submit" class="btn back-end-btn" value="啟用">
									<input type="hidden" name="memId" value="${memberVO.memId}">
