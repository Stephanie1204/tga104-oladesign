...
public class ExampleAllInOne {
	...
	public static void main(String[] args) {
		...
		bean.setOrderId("testCompany0009");
//		bean.setOrderId("220001" + "123456" + sdate.replaceAll(sdate, deleteChar));
		bean.setAmount(2000);
...
//		System.out.println("aioCheckOutDevide: " + genAioCheckOutDevide());
		System.out.println("aioCheckOutOneTime: " + genAioCheckOutOneTime(bean));
